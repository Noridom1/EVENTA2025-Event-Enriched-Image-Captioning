...
web_caption_pairs_path = 'images_final/image_caption_pairs.json'
web_images_base_path = 'images_final'
database_images_base_path = '../data/test/R1_final/'
output_path = '../CaptionEnriching/files/metadata_final_web_captions.json'
...
# === Main logic ===
metadata = [item for item in metadata if 'web_caption' not in item or item['web_caption'] == ""]
print(len(metadata))
